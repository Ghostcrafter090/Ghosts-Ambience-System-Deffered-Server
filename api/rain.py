...
class sounds:
    def rain():
        ...
        volume = (((0.458048 ** ( - 0.670194 * (utils.getLightningData() + 3.94567)) - 7.88269) + ((100 * utils.dataGrabber()[9][0]) + (100 * utils.dataGrabber()[9][1]) + (100 * utils.dataGrabber()[9][2])) * 0.3) * 7) + 15
        ...
        if utils.getLightningData() > 0:
            hailVolume = (0.458048 ** ( - 0.670194 * (utils.getLightningData() + 3.94567)) - 7.88269) + (100 * utils.dataGrabber()[9][2])
