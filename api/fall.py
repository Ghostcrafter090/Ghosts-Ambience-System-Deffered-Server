    ...
    while not status.exit:
        ...
        if (dateArray[1] < 12) and (dateArray[1] > 8):
            ...
            if ((dateArray[1] == 9) and (dateArray[2] >= 15)) or ((dateArray[1] == 10) and (dateArray[2] <= 15)):
                ...
                audio.playSoundWindow("leaves_early_m.mp3;leaves_early.mp3", [volume, volume, volume / 1.5], 1.0, 0.0, 0)
            ...
            if (dateArray[1] == 10) and (dateArray[2] < 25):
                ...
                audio.playSoundWindow("leaves_mid_m.mp3;leaves_mid.mp3", [volume, volume, volume / 1.5], 1.0, 0.0, 0)
            elif (dateArray[1] == 9):
            ...
            if (dateArray[1] == 10) and ((dateArray[2] >= 10) and (dateArray[2] <= 30)):
                ...
                audio.playSoundWindow("leaves_late_m.mp3;leaves_late.mp3", [volume, volume, volume / 1.5], 1.0, 0.0, 0)
            ...
            if ((dateArray[1] == 10) and (dateArray[2] >= 20)) or ((dateArray[1] == 11) and (dateArray[2] <= 5)):
                ...
                audio.playSoundWindow("leaves_end_m.mp3;leaves_end.mp3", [volume, volume, volume / 1.5], 1.0, 0.0, 0)
