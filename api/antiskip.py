...
def main():
    ...
    while not status.exit:
        globals.audio = importlib.reload(audio)
        audioEvent = globals.audio.event()
        print("Playing high pitch...")
        audioEvent.register("high_pitch.mp3", 0, 100, 1.0, 0.0, 0, remember=True)
        audioEvent.register("high_pitch.mp3", 1, 100, 1.0, 0.0, 0, remember=True)
        audioEvent.register("high_pitch.mp3", 2, 100, 1.0, 0.0, 0, remember=True)
