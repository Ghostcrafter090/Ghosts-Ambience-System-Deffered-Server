    ...
    while True:
        try:
            ...
            for sound in soundsList:
                ...
                if (float(soundCsv[2]) + float(soundCsv[3])) < pytools.clock.dateArrayToUTC(pytools.clock.getDateTime()):
...
def run():
    ...
    while True:
        ...
        pytools.IO.saveJson("..\gil.json", {
            ...
            "threadCount": speed.vars.threadCount
        })
