...
def main():
    ...
    while not status.exit:
        ...
        try:
            ...
            if (pytools.clock.getDateTime()[4] % 3) == 0:
                threading.Thread(target=pytools.IO.saveJson, args=("hallowForecastHourly.json", data.getMinutelyHallowData(),))
                threading.Thread(target=pytools.IO.saveJson, args=("hallowForecastBiHourly.json", data.getBiHourlyHallowData(),))
