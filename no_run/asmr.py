...
class candles:
    ...
    def run():
        ...
        if (((((pytools.clock.getDateTime()[2] != 24) and (pytools.clock.dateArrayToUTC(currentDayTimes[6]) < pytools.clock.dateArrayToUTC(pytools.clock.getDateTime()))) or ((pytools.clock.getDateTime()[2] == 24) and (pytools.clock.dateArrayToUTC([pytools.clock.getDateTime()[0], pytools.clock.getDateTime()[1], pytools.clock.getDateTime()[2], 18, 30, 0]) < pytools.clock.dateArrayToUTC(pytools.clock.getDateTime())))) or (pytools.clock.dateArrayToUTC(currentDayTimes[3]) > pytools.clock.dateArrayToUTC(pytools.clock.getDateTime())) or (tools.dataGrabber()[0][4] == "rain") or (tools.dataGrabber()[0][4] == "lightrain") or ((pytools.clock.getDateTime()[2] != 24) and (tools.dataGrabber()[0][4] == "snow")))):
