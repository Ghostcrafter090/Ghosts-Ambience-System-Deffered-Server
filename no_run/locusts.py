...
audioBuffer = audio.rapidFire(20)
    ...
    while not status.exit:
        ...
        if dataList[0][7] > 7:
            if (random.random() * 32768) < chance[5]:
                audioBuffer.playSoundWindow("slender_me_ka_m.mp3;slender_me_ka.mp3", [50, 50, 25], speed, 0, 0)
            if (random.random() * 32768) < chance[1]:
                audioBuffer.playSoundWindow("spahgnum_gr_cr_m.mp3;spahgnum_gr_cr.mp3", [50, 50, 25], speed, 0, 0)
            if (random.random() * 32768) < chance[2]:
                audioBuffer.playSoundWindow("striped_gr_cr_m.mp3;striped_gr_cr.mp3", [50, 50, 25], speed, 0, 0)
            if (random.random() * 32768) < chance[3]:
                audioBuffer.playSoundWindow("carolina_gr_cr_m.mp3;carolina_gr_cr.mp3", [50, 50, 25], speed, 0, 0)
            if (random.random() * 32768) < chance[4]:
                audioBuffer.playSoundWindow("allards_gr_cr_m.mp3;allards_gr_cr.mp3", [50, 50, 25], speed, 0, 0)
            ...
            if (random.random() * 32768) < chance[7]:
                audioBuffer.playSoundWindow("curvetail_bu_ka_m.mp3;curvetail_bu_ka.mp3", [50, 50, 25], speed, 0, 0)
            if (random.random() * 32768) < chance[8]:
                audioBuffer.playSoundWindow("forktail_bu_ka_m.mp3;forktail_bu_ka.mp3", [50, 50, 25], speed, 0, 0)
            if (random.random() * 32768) < chance[0]:
                audioBuffer.playSoundWindow("marsh_me_gr_m.mp3;marsh_me_gr.mp3", [50, 50, 25], speed, 0, 0)
            if (random.random() * 32768) < chance[9]:
                audioBuffer.playSoundWindow("says_ci_m.mp3;says_ci.mp3", [50, 50, 25], speed, 0, 0)
        else:
            time.sleep(60)
        ...
        if (random.random() * 32768) < chance[10]:
            if dateArray[3] < dayTimes[6][3]:
                if dateArray[3] >= dayTimes[2][3]:
                    audioBuffer.playSoundWindow("cicada_windowclosed.mp3;cicada_windowopen.mp3", [50, 50, 25], speed, 0, 0)
